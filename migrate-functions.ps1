# Crear el contenido del script paso a paso
$scriptContent = @'
Write-Host "🔧 INICIANDO MIGRACIÓN DE FUNCIONES..." -ForegroundColor Green

# Paso 1: Reemplazar funciones básicas de UI
...
Write-Host "✅ Funciones UI reemplazadas" -ForegroundColor Green
...
# Guardar cambios
$content | Set-Content $scriptPath -Encoding UTF8
Write-Host "✅ Llamadas a funciones reemplazadas" -ForegroundColor Green

Write-Host "🎉 MIGRACIÓN COMPLETADA!" -ForegroundColor Green
Write-Host "Revisa el archivo y prueba la aplicación." -ForegroundColor Cyan
'@

# Guardar el script
$scriptContent | Out-File -FilePath "migrate-fixed.ps1" -Encoding UTF8
Write-Host "✅ Script creado: migrate-fixed.ps1" -ForegroundColor Green